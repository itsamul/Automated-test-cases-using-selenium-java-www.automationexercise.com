...
public class TestCase_CreateUser {
	...
	public Object[][] createUserGetData() {
		return new Object[][] {
				{ "Penny Jones", "penny.jones@example.com", "Mrs", "Pass@123", "21", "March", "1986", "Yes", "Yes",
						"Penny", "Jones", "The PennyJones company", "29901 Elmore Shores", "Apt. 923", "United States",
						"Missouri", "Weissnatville", "205055", "19453439976" },
				{ "Darryl Langosh", "darryl.langosh@example.org", "Mr", "Pass@123", "12", "November", "1985", "Yes",
						"Yes", "Darryl", "Langosh", "The DarrylLangosh Company", "8421 Dooley Cove", "Suite 144",
						"United States", "Utah", "Macon-Bibb County", "233746", "13964843424" },
				{ "Jennie Rodriguez", "jennie.rodriguez@example.net", "Mrs", "Pass@123", "29", "August", "1999", "Yes",
						"Yes", "Jennie", "Rodriguez", "The JennieRodriguez Company", "84778 Ernesto Islands",
						"Suite 711", "United States", "Pennsylvania", "Volkmanberg", "788423", "14876828367" },
				{ "Frankie Carter", "frankie.carter@example.org", "Mr", "Pass@123", "16", "May", "1989", "Yes", "Yes",
						"Frankie", "Carter", "The FrankieCarter Company", "7405 Koss Land", "Suite 142",
						"United States", "Oklahoma", "Port Luciotown", "575032", "17398791370" }, };
	}

	@Test(dataProvider = "dpCreateUser")
	public void CreateUser(String str_Name, String str_Email, String str_Title, String str_Password, String str_Days,
			...
			String str_State, String str_City, String str_Zipcode, String str_MobileNumber) throws Exception {
		...
		Assert.assertEquals(driver.findElement(By.xpath("//section[@id='form']/div/div/div[3]/div/h2")).getText(),
				"New User Signup!");
		...
		Assert.assertEquals(driver.findElement(By.xpath("//div[@class='login-form']//h2/b")).getText(),
		...
		System.out.println(
				"12. Filled in details: First name, Last name, Company, Address, Address2, Country, State, City, Zipcode, Mobile Number");
		...
		Assert.assertTrue(
				driver.findElement(By.xpath("//section[@id='form']//h2/b[text()='Account Created!']")).isDisplayed());
