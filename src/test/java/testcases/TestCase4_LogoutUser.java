...
public class TestCase4_LogoutUser {
	...
	public void LogoutUser(String str_Email, String str_Password, String str_Name) {
		...
		System.out.println("9. Clicked 'Logout' button");
		Assert.assertEquals(driver.getTitle(), "Automation Exercise - Signup / Login");
		System.out.println("10. Verified that user is navigated to login page.");
