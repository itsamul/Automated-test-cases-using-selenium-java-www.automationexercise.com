...
public class TestCase14_PlaceOrderRegisterWhileCheckout {
	...
	public void testToPlaceOrderRegisterWhileCheckout(String str_Name, String str_Email, String str_Title,
			...
			String str_MobileNumber) throws InterruptedException {
		...
		new WebDriverWait(driver, Duration.ofSeconds(10)).until(ExpectedConditions.visibilityOf(driver.findElement(By.linkText("Register / Login")))).click();
		System.out.println("8. Click 'Register / Login' button");
		...
		System.out.println("9. Fill all details in Signup and create account");
		...
		System.out.println("10. Verify 'ACCOUNT CREATED!' and click 'Continue' button");

		// ***** HOME PAGE *****
		Assert.assertEquals(driver.findElement(By.xpath("//*[@id='header']//a/b")).getText(), str_Name);
		System.out.println("11. Verify ' Logged in as username' at top");

		driver.findElement(By.partialLinkText("Cart")).click();
		System.out.println("12. Click 'Cart' button");

		// ***** SHOPPING CART PAGE *****
		Assert.assertTrue(driver.findElement(By.xpath("//*[@id='cart_items']//li[text()='Shopping Cart']")).isDisplayed());
		Assert.assertEquals(driver.findElement(By.xpath("//*[@id='cart_items']//li[text()='Shopping Cart']")).getText(),"Shopping Cart");
		driver.findElement(By.linkText("Proceed To Checkout")).click();
		System.out.println("13. Click Proceed To Checkout");
		...
		System.out.println("14. Verify Address Details and Review Your Order");
		driver.findElement(By.xpath("//div[@id='ordermsg']//textarea")).sendKeys("This is the test message.");
		driver.findElement(By.linkText("Place Order")).click();
		System.out.println("15. Enter description in comment text area and click 'Place Order'");
		...
		System.out.println("16. Enter payment details: Name on Card, Card Number, CVC, Expiration date");
		driver.findElement(By.id("submit")).click();
		System.out.println("17. Click 'Pay and Confirm Order' button");
